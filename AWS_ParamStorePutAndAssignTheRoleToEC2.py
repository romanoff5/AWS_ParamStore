...
def create_cmk():
    ...
    key_i_dis = response['KeyMetadata']['KeyId']
    print("Key ARN:", key_arn_is)
    print("Key ID:", key_i_dis)
...
def get_var():
    ...
    iam_policy_name_for_the_ec2 = 'Project:' + project_name + '- Grants GetParameter and Decrypt permissions'
